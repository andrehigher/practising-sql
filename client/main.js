...
ReactDOM.render(
  <div>
    <nav classNameName="light-blue lighten-1" role="navigation">
      <div classNameName="nav-wrapper container"><a id="logo-container" href="#" classNameName="brand-logo">UFMG - Practising SQL</a>
        <ul classNameName="right hide-on-med-and-down">
          <li><a href="#">DCC</a></li>
        </ul>

        <ul id="nav-mobile" classNameName="side-nav">
          <li><a href="#">DCC</a></li>
        </ul>
        <a href="#" data-activates="nav-mobile" classNameName="button-collapse"><i classNameName="material-icons">menu</i></a>
      </div>
    </nav>
